...
const BrainCircuit = createLucideIcon("brain-circuit", __iconNode$t);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function PremiumPlansSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "premium", className: "py-24 relative", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "absolute inset-0 pointer-events-none",
        style: {
          background: "radial-gradient(ellipse 80% 60% at 50% 50%, oklch(0.6 0.22 258 / 0.04) 0%, transparent 70%)"
        }
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16 reveal-on-scroll", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-3xl sm:text-4xl font-bold uppercase text-foreground mb-4", children: [
          "Premium ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Plans" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-xl mx-auto", children: "Choose the plan that fits your supply chain needs. Upgrade anytime." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-6 items-stretch", children: plans.map((plan, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          style: {
            background: plan.highlighted ? "linear-gradient(160deg, oklch(0.6 0.22 258 / 0.14), oklch(0.65 0.25 290 / 0.10))" : "oklch(0.1 0.02 258 / 0.6)",
            border: `1px solid ${plan.colorBorder}`,
            boxShadow: plan.highlighted ? `0 8px 40px ${plan.colorGlow}` : `0 4px 20px ${plan.colorGlow}`
          },
          children: [
            plan.highlighted && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                style: {
                  background: "linear-gradient(90deg, oklch(0.75 0.2 195), oklch(0.55 0.22 258))",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              {
                type: "button",
                className: plan.highlighted ? "gradient-btn font-semibold px-6 py-3 rounded-full text-sm w-full" : "outline-btn font-semibold px-6 py-3 rounded-full text-sm w-full",
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background font-sans overflow-x-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(PremiumPlansSection, {})
    ] }),
